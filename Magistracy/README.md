...
- Разработать обобщенный класс-коллекцию  HashTable (хэш-таблица), предусмотрев возможность использования подключаемого интерфейса для реализации отношения эквивалентности, а также перечисления элементов коллекции. Разработать unit-тесты. Дополнительные возможности: создание пользовательской хэш-функции; разрешение коллизий.
