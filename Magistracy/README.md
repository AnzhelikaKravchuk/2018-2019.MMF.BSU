# Репозиторий спецкурса ".NET технологии" для магистрантов специальности "Веб-программирование и интернет-технологии" (срок обучения - 1 год, 1.5 года, 2 года, 2.5 года, очное и заочное), *отчетность - экзамен (1 год, 1.5 года) и зачет (2 года, 2.5 года)(предположительная дата экзамена/зачета 15.12.17).*
...
***Следующее занятие состоится в 8.15, 01.12.17, БГУ, аудитория 120, БГУ.***
