# Репозиторий спецкурса ".NET технологии" для магистрантов специальности Веб-программирование и интернет-технологии (1, 1.5, 2, 2.5 лет обучения, очное, заочное), отчетность - экзамен.
