# Репозиторий спецкурсов "Язык программирования C#. Основы ASP.NET" (*18 часов лекций + 16 часов лабораторных, форма отчетности - зачет*) и "Язык CSharp и основы платформы .NET" для студентов 3 курса (*20 часов лекций + 30 часов лабораторных, форма отчетности - зачет*).
