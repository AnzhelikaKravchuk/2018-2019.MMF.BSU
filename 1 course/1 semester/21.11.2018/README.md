...
- Реализовать функцию, определяющую отношение эквивалентности (равенство/неравенство) двух строк (как одномерных массивов char). Проверить работу функции в консоли.
...
*Во всех задачах предполагается работа со строками как массивом, элементами которого имеют тип char.*
